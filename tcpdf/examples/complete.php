<?php
    ...
    $sql_farmer .= "  AND b.pt_frm12 !='' AND b.pt_frm13 !='' AND b.pt_frm11 !='' AND b.pt_frm14 !='') ";
    ...
    if($tot_farmer >= 1)
    {
        while($row_farmer = mysqli_fetch_array($res_farmer))
        {
            ...
            // START : Farmer Info
            // =====================================================
            $sql_farmer_information = " SELECT tf.fm_name, tf.fm_aadhar, tf.fm_mobileno, tpd.f1_mfname, tpd.f1_father, tpd.f1_age, tpd.f1_dob, tpd.f1_altno, tpd.f1_expfarm, tpd.f1_any_other_occupation, tpd.f1_occupation_amt, tpd.f1_required_loan, tpd.f1_required_loan_amt, tpd.f1_loan_purpose, tpd.f1_crop_cycle, tsd.f3_married, trd.f7_resistatus, trd.f7_rent_amount
                FROM tbl_farmers AS tf INNER JOIN tbl_personal_detail AS tpd
                    ON tf.fm_id = tpd.fm_id INNER JOIN tbl_spouse_details AS tsd
                    ON tf.fm_id = tsd.fm_id INNER JOIN tbl_residence_details AS trd
                    ON tf.fm_id = trd.fm_id 
                WHERE tf.fm_id = '".$reforgid."' ";
            $res_farmer_information = mysqli_query($db_con, $sql_farmer_information) or die(mysqli_error($db_con));
            $num_farmer_information = mysqli_num_rows($res_farmer_information);
            ...
            $html1 = '<p><strong>Section  I - FARMER INFORMATION </strong></p>
                <table border="1" cellspacing="2" cellpadding="2" width="662">';
                    if($num_farmer_information != 0)
                    {
                        $row_farmer_information = mysqli_fetch_array($res_farmer_information);

                        $html1 .= '<tr>
                        <td width="255"><br />Name </td>
                            <td width="406" colspan="4"><p>';
                            if($row_farmer_information['fm_name'] != '')
                            {
                                $html1 .= $row_farmer_information['fm_name'];
                            }
                            else
                            {
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_farmer_information['f1_father'] != '')
                            {
                                $html1 .= $row_farmer_information['f1_father'];
                            }
                            else
                            {
                                $html1 .= '<span style="color:#E63A3A;"> Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_farmer_information['f1_mfname'] != '')
                            {
                                $html1 .= $row_farmer_information['f1_mfname'];
                            }
                            else
                            {
                                $html1 .= '<span style="color:#E63A3A;"> Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_farmer_information['f1_dob'] != '')
                            {
                                $html1 .= $row_farmer_information['f1_dob'];
                            }
                            else
                            {
                                $html1 .= '<span style="color:#E63A3A;"> Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_farmer_information['f1_age'] != '')
                            {
                                $html1 .= $row_farmer_information['f1_age'];
                            }
                            else
                            {
                                $html1 .= '<span style="color:#E63A3A;"> Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_farmer_information['fm_mobileno'] != '')
                            {
                                $html1 .= $row_farmer_information['fm_mobileno'];
                            }
                            else
                            {
                                $html1 .= '<span style="color:#E63A3A;"> Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_farmer_information['f1_altno'] != '')
                            {
                                $html1 .= $row_farmer_information['f1_altno'];
                            }
                            else
                            {
                                $html1 .= '<span style="color:#E63A3A;"> Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_farmer_information['fm_aadhar'] != '')
                            {
                                $html1 .= $row_farmer_information['fm_aadhar'];
                            }
                            else
                            {
                                $html1 .= '<span style="color:#E63A3A;"> Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_farmer_information['f1_expfarm'] != '')
                            {
                                $html1 .= $row_farmer_information['f1_expfarm'];
                            }
                            else
                            {
                                $html1 .= '<span style="color:#E63A3A;"> Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_farmer_information['f1_any_other_occupation'] != '')
                            {
                                $html1 .= $row_farmer_information['f1_any_other_occupation'];
                            }
                            else
                            {
                                $html1 .= '<span style="color:#E63A3A;"> Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_farmer_information['f1_occupation_amt'] != '')
                            {
                                $html1 .= $row_farmer_information['f1_occupation_amt'];
                            }
                            else
                            {
                                $html1 .= '<span style="color:#E63A3A;"> Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_farmer_information['f1_required_loan'] != '')
                            {
                                $html1 .= $row_farmer_information['f1_required_loan'];
                            }
                            else
                            {
                                $html1 .= '<span style="color:#E63A3A;"> Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_farmer_information['f1_required_loan_amt'] != '')
                            {
                                $html1 .= $row_farmer_information['f1_required_loan_amt'];
                            }
                            else
                            {
                                $html1 .= '<span style="color:#E63A3A;"> Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_farmer_information['f1_loan_purpose'] != '')
                            {
                                $html1 .= $row_farmer_information['f1_loan_purpose'];
                            }
                            else
                            {
                                $html1 .= '<span style="color:#E63A3A;"> Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_farmer_information['f1_crop_cycle'] != '')
                            {
                                $html1 .= $row_farmer_information['f1_crop_cycle'];
                            }
                            else
                            {
                                $html1 .= '<span style="color:#E63A3A;"> Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_farmer_information['f3_married'] != '')
                            {
                                $html1 .= $row_farmer_information['f3_married'];
                            }
                            else
                            {
                                $html1 .= '<span style="color:#E63A3A;"> Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_farmer_information['f7_resistatus'] != '')
                            {
                                $html1 .= $row_farmer_information['f7_resistatus'];
                            }
                            else
                            {
                                $html1 .= '<span style="color:#E63A3A;"> Incomplete</span>';
                        ...
                        if($row_farmer_information['f7_resistatus'] == 'Rented')
                        {
                            $html1 .= '<tr>
                                <td width="255"><br />Rent </td>
                                <td width="406" colspan="4"><p>';
                                if($row_farmer_information['f7_rent_amount'] != '')
                                {
                                    $html1 .= $row_farmer_information['f7_rent_amount'];
                                }
                                else
                                {
                                    $html1 .= '<span style="color:#E63A3A;"> Incomplete</span>';
            ...
            // =================================================================
            $sql_get_spouse_details = " SELECT * FROM tbl_spouse_details AS tsd WHERE tsd.fm_id = '".$reforgid."' ";
            $res_get_spouse_details = mysqli_query($db_con, $sql_get_spouse_details) or die(mysqli_error($db_con));
            $num_get_spouse_details = mysqli_num_rows($res_get_spouse_details);
            ...
            $html4 = '<p><strong>Section  IV - Spouse Details </strong></p>
                <table border="1" cellspacing="2" cellpadding="2" width="662">';
                    if($num_get_spouse_details != 0)
                    {
                        $row_get_spouse_details = mysqli_fetch_array($res_get_spouse_details);
                        if($row_get_spouse_details['f3_married'] == 'yes')
                        {
                            $html4 .= '<tr>
                            <td width="255"><br />Spouse Name </td>
                                <td width="406" colspan="4"><p>';
                                if($row_get_spouse_details['f3_spouse_fname'] != '')
                                {
                                    $html4 .= $row_get_spouse_details['f3_spouse_fname'];
                                }
                                else
                                {
                            ...
                            <tr>
                                ...
                                <td width="406" colspan="4"><p>';
                                if($row_get_spouse_details['f3_spouse_dob'] != '')
                                {
                                    $html4 .= $row_get_spouse_details['f3_spouse_dob'];
                                }
                                else
                                {
                                    $html4 .= '<span style="color:#e63a3a;">Incomplete</span>';
                            ...
                            <tr>
                                ...
                                <td width="406" colspan="4"><p>';
                                if($row_get_spouse_details['f3_spouse_age'] != '')
                                {
                                    $html4 .= $row_get_spouse_details['f3_spouse_age'];
                                }
                                else
                                {
                                    $html4 .= '<span style="color:#e63a3a;">Incomplete</span>';
                            ...
                            <tr>
                                <td width="255"><br />Mobile no. </td>
                                <td width="406" colspan="4"><p>';
                                if($row_get_spouse_details['f3_spouse_mobno'] != '')
                                {
                                    $html4 .= $row_get_spouse_details['f3_spouse_mobno'];
                                }
                                else
                                {
                                    $html4 .= '<span style="color:#e63a3a;">Incomplete</span>';
                            ...
                            <tr>
                                <td width="255"><br />Aadhaar no. </td>
                                <td width="406" colspan="4"><p>';
                                if($row_get_spouse_details['f3_spouse_adhno'] != '')
                                {
                                    $html4 .= $row_get_spouse_details['f3_spouse_adhno'];
                                }
                                else
                                {
                                    $html4 .= '<span style="color:#e63a3a;">Incomplete</span>';
                            ...
                            <tr>
                                ...
                                <td width="406" colspan="4"><p>';
                                if($row_get_spouse_details['f3_spouse_occp'] != '')
                                {
                                    $html4 .= $row_get_spouse_details['f3_spouse_occp'];
                                }
                                else
                                {
                                    $html4 .= '<span style="color:#e63a3a;">Incomplete</span>';
                            ...
                            <tr>
                                ...
                                <td width="406" colspan="4"><p>';
                                if($row_get_spouse_details['f3_is_fpo_member'] != '')
                                {
                                    $html4 .= $row_get_spouse_details['f3_is_fpo_member'];
                                }
                                else
                                {
                                    $html4 .= '<span style="color:#e63a3a;">Incomplete</span>';
            ...
            // =================================================================
            $sql_get_applicant_knowledge = " SELECT * FROM `tbl_applicant_knowledge` WHERE `fm_id`='".$reforgid."' ";
            $res_get_applicant_knowledge = mysqli_query($db_con, $sql_get_applicant_knowledge) or die(mysqli_error($db_con));
            $num_get_applicant_knowledge = mysqli_num_rows($res_get_applicant_knowledge);

            $pdf->AddPage();
            $html5 = '<p><strong>Section  V - Applicant\'s Knowledge </strong></p>
                <table border="1" cellspacing="2" cellpadding="2" width="662">';
                    if($num_get_applicant_knowledge != 0)
                    {
                        $row_get_applicant_knowledge = mysqli_fetch_array($res_get_applicant_knowledge);
                        $html5 .= '<tr>
                            <td width="255"><br />Educational Qualification Details </td>
                            <td width="406" colspan="4"><p>';
                            if($row_get_applicant_knowledge['f2_edudetail'] != '')
                            {
                                $html5 .= ucwords($row_get_applicant_knowledge['f2_edudetail']);
                            }
                            else
                            {
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_get_applicant_knowledge['f2_proficiency'] != '')
                            {
                                $html5 .= ucwords($row_get_applicant_knowledge['f2_proficiency']);
                            }
                            else
                            {
                                $html5 .= '<span style="color:#e63a3a;">Incomplete</span>';
            ...
            // START : Phone Details
            // =================================================================
            $sql_get_phone_details = " SELECT * FROM `tbl_applicant_phone` WHERE `fm_id`='".$reforgid."' ";
            $res_get_phone_details = mysqli_query($db_con, $sql_get_phone_details) or die(mysqli_error($db_con));
            $num_get_phone_details = mysqli_num_rows($res_get_phone_details);
            ...
            $html6 = '<p><strong>Section  VI - Phone Details </strong></p>
                <table border="1" cellspacing="2" cellpadding="2" width="662">';
                    if($num_get_phone_details != 0)
                    {
                        $row_get_phone_details = mysqli_fetch_array($res_get_phone_details);

                        $html6 .= '<tr>
                        <td width="255"><br />Type of phone ownership </td>
                            <td width="406" colspan="4"><p>';
                            if($row_get_phone_details['f5_phonetype'] != '')
                            {
                                $html6 .= ucwords($row_get_phone_details['f5_phonetype']);
                            }
                            else
                            {
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_get_phone_details['f5_any_one_have_smart_phone'] != '')
                            {
                                $html6 .= ucwords($row_get_phone_details['f5_any_one_have_smart_phone']);
                            }
                            else
                            {
                                $html6 .= '<span style="color:#e63a3a;">Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_get_phone_details['f5_network'] != '')
                            {
                                $html6 .= ucwords($row_get_phone_details['f5_network']);
                            }
                            else
                            {
                                $html6 .= '<span style="color:#e63a3a;">Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_get_phone_details['f5_datapack'] != '')
                            {
                                $html6 .= ucwords($row_get_phone_details['f5_datapack']);
                            }
                            else
                            {
                                $html6 .= '<span style="color:#e63a3a;">Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_get_phone_details['f5_datapackname'] != '')
                            {
                                $html6 .= ucwords($row_get_phone_details['f5_datapackname']);
                            }
                            else
                            {
                                $html6 .= '<span style="color:#e63a3a;">Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_get_phone_details['f5_appuse'] != '')
                            {
                                $html6 .= $row_get_phone_details['f5_appuse'];
                            }
                            else
                            {
                                $html6 .= '<span style="color:#e63a3a;">Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_get_phone_details['f5_app_name'] != '')
                            {
                                $html6 .= $row_get_phone_details['f5_app_name'];
                            }
                            else
                            {
                                $html6 .= '<span style="color:#e63a3a;">Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_get_phone_details['f5_farmapp'] != '')
                            {
                                $html6 .= $row_get_phone_details['f5_farmapp'];
                            }
                            else
                            {
                                $html6 .= '<span style="color:#e63a3a;">Incomplete</span>';
            ...
            // =================================================================
            $sql_get_family_details = " SELECT * FROM `tbl_family_details` WHERE `fm_id`='".$reforgid."' ";
            $res_get_family_details = mysqli_query($db_con, $sql_get_family_details) or die(mysqli_error($db_con));
            $num_get_family_details = mysqli_num_rows($res_get_family_details);

            $pdf->AddPage();
            $html7 = '<p><strong>Section  VII - Famity Details </strong></p>
                <table border="1" cellspacing="2" cellpadding="2" width="662">';
                    if($num_get_family_details != 0)
                    {
                        $row_get_family_details = mysqli_fetch_array($res_get_family_details);

                        $html7 .= '<tr>
                        <td width="255"><br />How many members are there in your family? </td>
                            <td width="406" colspan="4"><p>';
                            if($row_get_family_details['f6_members'] != '')
                            {
                                $html7 .= $row_get_family_details['f6_members'];
                            }
                            else
                            {
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_get_family_details['f6_children'] != '')
                            {
                                $html7 .= $row_get_family_details['f6_children'];
                            }
                            else
                            {
                                $html7 .= '<span style="color:#e63a3a;">Incomplete</span>';
            ...
            // =================================================================
            $sql_get_appliances_motors = " SELECT * FROM `tbl_residence_details` WHERE `fm_id`='".$reforgid."' ";
            $res_get_appliances_motors = mysqli_query($db_con, $sql_get_appliances_motors) or die(mysqli_error($db_con));
            $num_get_appliances_motors = mysqli_num_rows($res_get_appliances_motors);

            $pdf->AddPage();
            $html8 = '<p><strong>Section  VIII - Appliances / Motors </strong></p>
                <table border="1" cellspacing="2" cellpadding="2" width="662">';
                    if($num_get_appliances_motors != 0)
                    {
                        $row_get_appliances_motors = mysqli_fetch_array($res_get_appliances_motors);

                        $html8 .= '<tr>
                        <td width="255"><br />Television  </td>
                            <td width="406" colspan="4"><p>';
                            if($row_get_appliances_motors['f7_television'] != '')
                            {
                                $html8 .= $row_get_appliances_motors['f7_television'];
                            }
                            else
                            {
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_get_appliances_motors['f7_refrigerator'] != '')
                            {
                                $html8 .= $row_get_appliances_motors['f7_refrigerator'];
                            }
                            else
                            {
                                $html8 .= '<span style="color:#e63a3a;">Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_get_appliances_motors['f7_wmachine'] != '')
                            {
                                $html8 .= $row_get_appliances_motors['f7_wmachine'];
                            }
                            else
                            {
                                $html8 .= '<span style="color:#e63a3a;">Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_get_appliances_motors['f7_mixer'] != '')
                            {
                                $html8 .= $row_get_appliances_motors['f7_mixer'];
                            }
                            else
                            {
                                $html8 .= '<span style="color:#e63a3a;">Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_get_appliances_motors['f7_stove'] != '')
                            {
                                $html8 .= $row_get_appliances_motors['f7_stove'];
                            }
                            else
                            {
                                $html8 .= '<span style="color:#e63a3a;">Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_get_appliances_motors['f7_bicycle'] != '')
                            {
                                $html8 .= $row_get_appliances_motors['f7_bicycle'];
                            }
                            else
                            {
                                $html8 .= '<span style="color:#e63a3a;">Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_get_appliances_motors['f7_ccylinder'] != '')
                            {
                                $html8 .= $row_get_appliances_motors['f7_ccylinder'];
                            }
                            else
                            {
                                $html8 .= '<span style="color:#e63a3a;">Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_get_appliances_motors['f7_fans'] != '')
                            {
                                $html8 .= $row_get_appliances_motors['f7_fans'];
                            }
                            else
                            {
                                $html8 .= '<span style="color:#e63a3a;">Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_get_appliances_motors['f7_motorcycle'] != '')
                            {
                                $html8 .= $row_get_appliances_motors['f7_motorcycle'];
                            }
                            else
                            {
                                $html8 .= '<span style="color:#e63a3a;">Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_get_appliances_motors['f7_car'] != '')
                            {
                                $html8 .= $row_get_appliances_motors['f7_car'];
                            }
                            else
                            {
                                $html8 .= '<span style="color:#e63a3a;">Incomplete</span>';
            ...
            // =================================================================
            $sql_get_assets_details = " SELECT * FROM `tbl_asset_details` WHERE `fm_id`='".$reforgid."' ";
            $res_get_assets_details = mysqli_query($db_con, $sql_get_assets_details) or die(mysqli_error($db_con));
            $num_get_assets_details = mysqli_num_rows($res_get_assets_details);

            $pdf->AddPage();
            $html13 = '<p><strong>Section  XIII - Assets Details </strong></p>
                <table border="1" cellspacing="2" cellpadding="2" width="662">';
                    if($num_get_assets_details != 0)
                    {
                        $row_get_assets_details = mysqli_fetch_array($res_get_assets_details);

                        $html13 .= '<tr>
                        <td width="255"><br />TRACTOR  </td>
                            <td width="406" colspan="4"><p>';
                            if($row_get_assets_details['f12_TRACTOR'] != '')
                            {
                                $html13 .= $row_get_assets_details['f12_TRACTOR'];
                            }
                            else
                            {
                        ...
                        <tr>
                            <td width="255"><br />vehicle Owned </td>
                            <td width="406" colspan="4"><p>';
                            if($row_get_assets_details['f12_vehicle'] != '')
                            {
                                $html13 .= $row_get_assets_details['f12_vehicle'];
                            }
                            else
                            {
                                $html13 .= '<span style="color:#e63a3a;">Incomplete</span>';
                        ...
                        <tr>
                            <td width="255"><br />Total Value of the vehicle </td>
                            <td width="406" colspan="4"><p>';
                            if($row_get_assets_details['f12_total_val_of_vehical'] != '')
                            {
                                $html13 .= $row_get_assets_details['f12_total_val_of_vehical'];
                            }
                            else
                            {
                                $html13 .= '<span style="color:#e63a3a;">Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_get_assets_details['f12_Protavator'] != '')
                            {
                                $html13 .= $row_get_assets_details['f12_Protavator'];
                            }
                            else
                            {
                                $html13 .= '<span style="color:#e63a3a;">Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_get_assets_details['f12_Sprayer'] != '')
                            {
                                $html13 .= $row_get_assets_details['f12_Sprayer'];
                            }
                            else
                            {
                                $html13 .= '<span style="color:#e63a3a;">Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_get_assets_details['f12_Pumps'] != '')
                            {
                                $html13 .= $row_get_assets_details['f12_Pumps'];
                            }
                            else
                            {
                                $html13 .= '<span style="color:#e63a3a;">Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_get_assets_details['f12_Cultivators'] != '')
                            {
                                $html13 .= $row_get_assets_details['f12_Cultivators'];
                            }
                            else
                            {
                                $html13 .= '<span style="color:#e63a3a;">Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_get_assets_details['f12_machinery'] != '')
                            {
                                $html13 .= $row_get_assets_details['f12_machinery'];
                            }
                            else
                            {
                                $html13 .= '<span style="color:#e63a3a;">Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_get_assets_details['f12_total_val_of_machinery'] != '')
                            {
                                $html13 .= $row_get_assets_details['f12_total_val_of_machinery'];
                            }
                            else
                            {
                                $html13 .= '<span style="color:#e63a3a;">Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_get_assets_details['f12_any_other_assets'] != '')
                            {
                                $html13 .= $row_get_assets_details['f12_any_other_assets'];
                            }
                            else
                            {
                                $html13 .= '<span style="color:#e63a3a;">Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_get_assets_details['f12_name_of_other_assets'] != '')
                            {
                                $html13 .= $row_get_assets_details['f12_name_of_other_assets'];
                            }
                            else
                            {
                                $html13 .= '<span style="color:#e63a3a;">Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_get_assets_details['f12_mention_value_of_assets'] != '')
                            {
                                $html13 .= $row_get_assets_details['f12_mention_value_of_assets'];
                            }
                            else
                            {
                                $html13 .= '<span style="color:#e63a3a;">Incomplete</span>';
            ...
            // START : Live Stock 
            // =================================================================
            $sql_get_live_stock = " SELECT * FROM `tbl_livestock_details` WHERE `fm_id`='".$reforgid."' ";
            $res_get_live_stock = mysqli_query($db_con, $sql_get_live_stock) or die(mysqli_error($db_con));
            $num_get_live_stock = mysqli_num_rows($res_get_live_stock);

            $pdf->AddPage();
            $html14 = '<p><strong>Section  XIV - Live Stock </strong></p>
                <table border="1" cellspacing="2" cellpadding="2" width="662">';
                    if($num_get_live_stock != 0)
                    {
                        $row_get_live_stock = mysqli_fetch_array($res_get_live_stock);

                        $html14 .= '<tr>
                        <td width="255"><br />Dairy Cattle  </td>
                            <td width="406" colspan="4"><p>';
                            if($row_get_live_stock['f13_dairy_cattle'] != '')
                            {
                                $html14 .= $row_get_live_stock['f13_dairy_cattle'];
                            }
                            else
                            {
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_get_live_stock['f13_draft_cattle'] != '')
                            {
                                $html14 .= $row_get_live_stock['f13_draft_cattle'];
                            }
                            else
                            {
                                $html14 .= '<span style="color:#e63a3a;">Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_get_live_stock['f13_buffalo'] != '')
                            {
                                $html14 .= $row_get_live_stock['f13_buffalo'];
                            }
                            else
                            {
                                $html14 .= '<span style="color:#e63a3a;">Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_get_live_stock['f13_ox'] != '')
                            {
                                $html14 .= $row_get_live_stock['f13_ox'];
                            }
                            else
                            {
                                $html14 .= '<span style="color:#e63a3a;">Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_get_live_stock['f13_sheep'] != '')
                            {
                                $html14 .= $row_get_live_stock['f13_sheep'];
                            }
                            else
                            {
                                $html14 .= '<span style="color:#e63a3a;">Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_get_live_stock['f13_goat'] != '')
                            {
                                $html14 .= $row_get_live_stock['f13_goat'];
                            }
                            else
                            {
                                $html14 .= '<span style="color:#e63a3a;">Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_get_live_stock['f13_pig'] != '')
                            {
                                $html14 .= $row_get_live_stock['f13_pig'];
                            }
                            else
                            {
                                $html14 .= '<span style="color:#e63a3a;">Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_get_live_stock['f13_poultry'] != '')
                            {
                                $html14 .= $row_get_live_stock['f13_poultry'];
                            }
                            else
                            {
                                $html14 .= '<span style="color:#e63a3a;">Incomplete</span>';
                        ...
                        <tr>
                            ...
                            <td width="406" colspan="4"><p>';
                            if($row_get_live_stock['f13_donkeys'] != '')
                            {
                                $html14 .= $row_get_live_stock['f13_donkeys'];
                            }
                            else
                            {
                                $html14 .= '<span style="color:#e63a3a;">Incomplete</span>';
            ...
            if($num_get_financial_details != 0)
            {
                ...
                if($num_get_tbl_bank_loan_detail != 0)
                {
                    ...
                    $pdf->AddPage();
                    $html15 = '<p><strong>Section  XV - Financial History </strong></p>
                        <table border="1" cellspacing="2" cellpadding="2" width="662">
                            <tr>
            ...
            if($num_get_financial_history != 0)
            {
                ...
                $pdf->AddPage();
                $html16 = '<p><strong>Section  XVI - Financial History </strong></p>
                    <table border="1" cellspacing="2" cellpadding="2" width="662">
                        <tr>
            ...
            // echo $html1.'<br>'.$html2.'<br>'.$html3.'<br>'.$html4.'<br>'.$html5.'<br>'.$html6.'<br>'.$html7.'<br>'.$html8.'<br>'.$html9.'<br>'.$html10.'<br>'.$html11.'<br>'.$html12.'<br>'.$html13.'<br>'.$html14;
            ...
            $pdf->Output('../../data/complete/'.$row_farmer['fm_caid'].'_'.$row_farmer['fm_id'].'_'.$row_farmer['fm_name']."_complete".'.pdf', 'F');
        }
        //============================================================
        // END OF FILE
        //============================================================
