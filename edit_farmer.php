<?php 
    ...
    $farmer =  new Farmer_info();
    $farmer->setFarmerId($fm_id);
    $farmer_info = $farmer->getFarmerInfo();
...
<html class="not-ie no-js" lang="en">
    ...
    <body class="<?php echo THEME_NAME; ?>" data-theme="<?php echo THEME_NAME; ?>">
                        ...
                        <div class="box-content nopadding">
                            <form method="POST" enctype="multipart/form-data" class='form-horizontal form-bordered form-validate' id="frm_edit_farmer" name="frm_edit_farmer">
                                ...
                                <input type="hidden" id="f3_married_reg_points" name="f3_married_reg_points" value="">
                                 ...
                                 <input type="hidden" id="fm_id" name="fm_id" value="<?php echo $farmer_info['fm_id'] ?>">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" id="txt_name" name="txt_name" class="input-xlarge v_name" data-rule-required="true" placeholder="Enter Name" value="<?php echo $farmer_info['fm_name'] ?>">
                                    </div>
                                </div>  <!-- Name -->
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select id="fm_district" onchange="getTaluka(this.value)" name="fm_district" class="select2-me input-xlarge" >
                                            ...
                                            <?php
                                            $states = $location->getDistrict($farmer_info['fm_state']);
                                            foreach($states as $state){
                                                echo '<option value="'.$state['id'].'">'.ucfirst($state['dt_name']).'</option>';
                                            }
                                            ?>
                                        </select>
                                    </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select id="fm_taluka" onchange="getVillage(this.value)"  name="fm_taluka" class="select2-me input-xlarge" >
                                            ...
                                            <?php
                                            $states = $location->getTaluka($farmer_info['fm_district']);
                                            foreach($states as $state){
                                                echo '<option value="'.$state['id'].'">'.ucfirst($state['tk_name']).'</option>';
                                            }
                                            ?>
                                        </select>
                                    </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select id="fm_village" name="fm_village" class="select2-me input-xlarge" >
                                            ...
                                            <?php
                                            $villages = $location->getVillage($farmer_info['fm_taluka']);


                                            foreach($villages as $village){
                                                echo '<option value="'.$village['id'].'">'.ucfirst($village['vl_name']).'</option>';
                                            }
                                            ?>
                                        </select>
                                    </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input <?php echo $farmer_info['education_status']=='yes'?'checked':'' ?> type="radio" name="educational_status"  value="yes" /> Educated 

                                        <input <?php echo $farmer_info['education_status']=='no'?'checked':'' ?> type="radio" name="educational_status"  value="no" /> Non-Educated 
                                    </div>
                                </div>  <!-- Father's / fm_state -->
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input <?php echo $farmer_info['fm_gender']=='Male'?'checked':'' ?> type="radio" name="gender"  value="Male" /> Male 

                                        <input <?php echo $farmer_info['fm_gender']=='Female'?'checked':'' ?> type="radio" name="gender"  value="Female" /> Female
                                    </div>
                                </div>  <!-- Father's / fm_state -->
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" id="txt_dob" name="txt_dob" placeholder="Date Of Birth" value="<?php echo $farmer_info['fm_date_of_birth'] ?>" class="datepicker input-large" data-rule-required="true" />
                                    </div>
                                </div>  <!-- DOB -->
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" id="txt_age" name="txt_age" placeholder="Age" class="input-large" data-rule-required="true" data-rule-number="true"  value="<?php echo $farmer_info['fm_age'] ?>" readonly />
                                    </div>
                                </div>  <!-- Age In-Between -->
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" placeholder="Mobile no" name="fm_mobileno" id="fm_mobileno" maxlength="10"  autocomplete="off" data-rule-required="true" onBlur="Mobile(this.value);"  data-rule-minlength="10" value="<?php echo $farmer_info['fm_mobileno'] ?>"  data-rule-maxlength="10" class="input-xlarge v_number">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" placeholder="Alternative Mobile no" name="alt_mobileno" id="alt_mobileno" data-rule-number="true" maxlength="10" autocomplete="off" onBlur="Mobile(this.value);"  value="<?php echo $farmer_info['fm_landline'] ?>" data-rule-minlength="10"  data-rule-maxlength="10" class="input-xlarge v_number">
                                        <label id="comp_2" style="color:#FF0000;width:200px;margin-left:100px;"></label>    
                                    </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="email" placeholder="Email" name="fm_email" id="fm_email" class="input-xlarge" value="<?php echo $farmer_info['fm_email'] ?>">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" placeholder="residing in this area" name="fm_residing_area" id="fm_residing_area" class="v_number input-xlarge" data-rule-number="true" data-rule-required="true" value="<?php echo $farmer_info['fm_residing_area'] ?>" data-rule-maxlength="2"> In years
                                    </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" placeholder="Personal Experience" name="personal_experience" id="personal_experience" class="v_number input-xlarge" data-rule-number="true" data-rule-required="true"  value="<?php echo $farmer_info['personal_experience'] ?>" > In years
                                    </div>
                                </div>  <!-- Experience In Farming -->
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" placeholder="No. of family members" name="no_of_family_members" id="no_of_family_members" class="v_number input-xlarge" data-rule-number="true" data-rule-required="true" value="<?php echo $farmer_info['no_of_family_members'] ?>" min="0" max="50" >
                                    </div>
                                </div>  <!-- Experience In Farming -->
        ...
        <script language="javascript">
            ...
            $('#fm_state').val('<?php echo $farmer_info['fm_state'] ?>');
            $('#fm_district').val(<?php echo $farmer_info['fm_district'] ?>);
            $('#fm_taluka').val(<?php echo $farmer_info['fm_taluka'] ?>);
            $('#fm_org_id').val('<?php echo $farmer_info['fm_org_id'] ?>');
            $('#fm_village').val('<?php echo $farmer_info['fm_village'] ?>'); 
            $('#ddl_married_status').val('<?php echo $farmer_info['fm_marital_status'] ?>');
            ...
            $('#frm_edit_farmer').on('submit', function(e) 
            {
                ...
                if ($('#frm_edit_farmer').valid())
                {
                    ...
                    $.ajax({
                        url: "action/farmer.php?request=edit",
                        type: "POST",
