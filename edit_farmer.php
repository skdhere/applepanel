                            ...
                            <form method="POST" enctype="multipart/form-data" class='form-horizontal form-bordered form-validate' id="frm_edit_farmer" name="frm_edit_farmer">
                                        ...
                                        <select id="fm_org_id" name="fm_org_id" class="select2-me input-xlarge" >
                                            ...
                                            if($res_get_list_of_fpos)
                                            {
                                                ...
                                                if($num_get_list_of_fpos != 0)
                                                {
                                                    ...
                                                    {
                                                        ?>
                                                        <option value="<?php echo $row_get_list_of_fpos['id']; ?>" <?php if($row_get_list_of_fpos['id'] == $row_get_farmer_info['fm_org_id']) { ?> selected <?php } ?>>
                                                            <?php echo ucwords($row_get_list_of_fpos['org_name']); ?>
                                                        </option>
                                                        <?php
                                                    }
                                                }
                                ...
                                <div class="control-group">
                                	<label for="tasktitel" class="control-label">
                                    	Date Of Birth <span style="color:#F00">*</span><br>[YYYY-MM-DD]
                                    </label>
                                    <div class="controls">
                                ...
                                <div class="control-group">
                                	<label for="numberfield" class="control-label">
                                    	Mobile No. <span style="color:#F00">*</span><br>[10 Digits]
                                    </label>
                                	<div class="controls">
