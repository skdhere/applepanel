                        ...
                        <div class="box-content nopadding">
                            <form method="POST" enctype="multipart/form-data" class='form-horizontal form-bordered form-validate' id="frm_edit_farmer" name="frm_edit_farmer">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select id="fm_caid" name="fm_caid" class="select2-me input-xlarge" >
                                            <?php
                                            // Query For getting the list of the all FPOs
                                            $res_get_list_of_fpos = getRecord('tbl_change_agents', array('userType'=>'FPO'));
                                            if($res_get_list_of_fpos)
                                            {
                                                ...
                                                if($num_get_list_of_fpos != 0)
                                                {
                                                    ...
                                                    {
                                                        ?>
                                                        <option value="<?php echo $row_get_list_of_fpos['id']; ?>" <?php if($row_get_list_of_fpos['id'] == $row_get_farmer_info['fm_caid']) { ?> selected <?php } ?>>
                                                            <?php echo ucwords($row_get_list_of_fpos['fname']); ?>
                                                        </option>
                                                        <?php
                                                    }
                                                }
