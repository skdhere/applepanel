<?php
	...
	$feature_name 	= 'Already taken loan Reports';
	$home_name    	= "Home";
	$title			= 'SqoreYard | Already taken loan Report';
	$home_url 	  	= "home.php";
	$filename		= 'report_loan_already_taken.php';
        ...
        <script type="text/javascript">
            ...
            function loadFarmerData()
            {
                ...
                else
                {
                    ...
                    $.ajax({
                        url: "load_report_loan_already_taken.php?",
                        type: "POST",
                        data: farmer_load,
