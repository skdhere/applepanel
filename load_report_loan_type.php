<?php
	...
	if((isset($obj->load_farmer)) == '1' && (isset($obj->load_farmer)))
	{
		...
		if($page != "" && $per_page != "")	
		{
			...
			$sql_load_data  .= " FROM `tbl_farmers` AS tf INNER JOIN `tbl_bank_loan_detail` AS tp ON tf.fm_id = tp.fm_id ";
			...
			if($hid_page_type == 'Education')
			{
				$sql_load_data  .= " AND tp.f8_loan_type = 'Education' ";	
			}

			if($hid_page_type == 'Land')
			{
				$sql_load_data  .= " AND tp.f8_loan_type = 'Land' ";
			}

			if($hid_page_type == 'Agriculture')
			{
				$sql_load_data  .= " AND tp.f8_loan_type = 'Agriculture' ";
			}

			if($hid_page_type == 'Two Wheeler')
			{
				$sql_load_data  .= " AND tp.f8_loan_type = 'Two Wheeler' ";
			}

			if($hid_page_type == 'Equipment')
			{
				$sql_load_data  .= " AND tp.f8_loan_type = 'Equipment' ";
			}

			if($hid_page_type == 'Irrigation')
			{
				$sql_load_data  .= " AND tp.f8_loan_type = 'Irrigation' ";
			}

			if($hid_page_type == 'Fencing')
			{
				$sql_load_data  .= " AND tp.f8_loan_type = 'Fencing' ";
			}

			if($hid_page_type == 'Housing')
			{
				$sql_load_data  .= " AND tp.f8_loan_type = 'Housing' ";
			}

			if($hid_page_type == 'Construction OR Renovation')
			{
				$sql_load_data  .= " AND tp.f8_loan_type = 'Construction OR Renovation' ";
			}

			if($hid_page_type == 'Four Wheeler')
			{
				$sql_load_data  .= " AND tp.f8_loan_type = 'Four Wheeler' ";
			}

			if($hid_page_type == 'Electronics')
			{
				$sql_load_data  .= " AND tp.f8_loan_type = 'Electronics' ";
			}

			if($hid_page_type == 'NA')
			{
				$sql_load_data  .= " AND tp.f8_loan_type = 'NA' ";
			}

			if($hid_page_type == 'Others')
			{
				$sql_load_data  .= " AND tp.f8_loan_type = 'Others' ";
			}
				...
				while($row_load_data = mysqli_fetch_array($result_load_data))
				{
					...
					$cat_data .= '<tr>';				
						...
						$cat_data .= '<td>';
							...
							if($hid_page_type == 'Agriculture')
							{
								$cat_data .= "Agriculture";	
							}
							
							if($hid_page_type == 'Two Wheeler')
							{
								$cat_data .= "Two Wheeler";
							}
							...
							if($hid_page_type == 'Construction OR Renovation')
							{
								$cat_data .= "Construction OR Renovation";	
							}
							
							if($hid_page_type == 'Four Wheeler')
							{
								$cat_data .= "Four Wheeler";
							}
							
							if($hid_page_type == 'Electronics')
							{
								$cat_data .= "Electronics";	
							}
