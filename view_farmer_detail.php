...
<html>
                        ...
                        <div class="span12">
                            <div class="box box-color box-bordered">
                                <div class="box-title">
                                    ...
                                    <button onclick="download_pdf()"  class="btn btn-success fleft">Download Pdf</button>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                </div>
                                ...
                                <table id="tbl_farmer" class="table table-bordered" style="width:100%;text-align:center">
	                                <tbody>
	                                	<tr>
		                                	<td><b>Name</b> : <?php echo $farmer_name ?></td>
		                                	<td><b>Point :</b> <?php echo round($avg_of_points, 2); ?> </td>
	                                	</tr>
                                		<tr>
                                			<th colspan="2" class="text-center">Spouse Details</th>
                                		</tr>
	                                	<tr>
		                                	<td><b>Spouse Name</b> : <?php echo @$data['f3_spouse_fname'] ?></td>
		                                	<td><b>Spouse Date Of Birth  :</b> <?php echo checkIsset($data['f3_spouse_dob']); ?> </td>
	                                	</tr>
	                                	<tr>
		                                	<td><b>Mobile no.</b> : <?php echo @$data['f3_spouse_mobno'] ?></td>
		                                	<td><b>Aadhaar no.  :</b> <?php echo checkIsset($data['f3_spouse_adhno']); ?> </td>
	                                	</tr>
	                                	<tr>
		                                	<td><b>Occupation</b> : <?php echo @$data['f3_spouse_occp'] ?></td>
		                                	<td><b>Is the Spouse also member of the same FPO?  :</b> <?php echo checkIsset($data['f3_is_fpo_member']); ?> </td>
	                                	<tr>
	                                	<tr>
    ...
    <script type="text/javascript">
    	...
    	{
    		var sendInfo	= {"downloadPdf":1, "fm_id":<?php echo $fm_id; ?>};
			var dist_load 	= JSON.stringify(sendInfo);
			
			$.ajax({
				url: "tcpdf/examples/getFarmerDetailPdf.php?",
				type: "POST",
				data: dist_load,
