<?php
	...
	$feature_name 	= 'Farmers Reports';
	$home_name    	= "Home";
	$title			= 'SqoreYard | Farmers Report';
	$home_url 	  	= "home.php";
...
<html>
    ...
    <body class="<?php echo $theme_name; ?>" data-theme="<?php echo $theme_name; ?>">
                            ...
                            <div class="box box-color box-bordered" >
                                <div class="box-title">
                                    ...
                                    <div style="margin-left: 20%;">
                                        <select id="ddl_farmer_type" name="ddl_farmer_type" class="select2-me input-large" onChange="getFarmerType(this.value);" >
                                            <option value="total_reg" <?php if($page == 'total_reg'){ ?> selected <?php } ?>>All Farmers</option>
                                            <option value="total_com" <?php if($page == 'total_com'){ ?> selected <?php } ?>>Complete Farmers</option>
                                            <option value="total_incom" <?php if($page == 'total_incom'){ ?> selected <?php } ?>>Incomplete Farmers</option>
                                        </select>
                                    </div>
                                </div>
        ...
        <script type="text/javascript">
            ...
            function getFarmerType(farmer_type)
            {
                $("#hid_page_type").val(farmer_type);
                loadFarmerData();                
            }
            ...
            function getDisplayViewUploadDiv(div_id)
            {
                $("#"+div_id).toggle();
            }
        </script>
