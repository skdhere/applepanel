                        ...
                        <div class="box box-color box-bordered green">
                            ...
                            <form method="POST" enctype="multipart/form-data" class='form-horizontal form-bordered form-validate' id="add_fpo_users" name="add_fpo_users">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" id="txt_name" name="txt_name" class="input-xlarge v_name" data-rule-required="true" placeholder="Enter FPO Name">
                                    </div>
                                </div>  <!-- Name -->
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" id="txt_email" name="txt_email" class="input-xlarge" data-rule-required="true" data-rule-email="true" placeholder="Enter FPO Email Address">
                                    </div>
                                </div>  <!-- Email / Username -->
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" id="txt_password" name="txt_password" class="input-xlarge" data-rule-required="true" placeholder="Enter FPO Password" >
                                    </div>
                                </div>  <!-- Password -->
